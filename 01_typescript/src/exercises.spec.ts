...
describe('What is typescript?', () => {
  ...
  */
  ...
  it('adds type annotations 5', () => {
    function greetFancy(person: { name: string; origin: string }): string {
      return `Greetings, ${person.name} of ${person.origin}.`;
    }

    expect(greetFancy({ name: 'Frodo', origin: 'The Shire' })).toEqual(
      'Greetings, Frodo of The Shire.'
    );
  });
  ...
  */
  ...
  it('has interfaces 1', () => {
    ...
    // ED Q: Why is the PersonModel needed?
